<?php
	...
	WHERE resguardos_personal.estado='2' and equipos.estado_baja='1'";
	...
	<body>
		...
		<div class="container">
				...
				<div class="container">
				 <div class="row">
					...
					<div class="col-sm-6">
						...
						<h4 style="text-align:center">Resguardos Internos Antiguos</h4>
					</div>
					<div class="col-sm-3">
			...
			<div class="row">
				...
				<?php { ?><a href="pdf4.php?id=<?php echo $id_all; ?>"> <?php }?><span class="btn btn-warning">Imprimir</span></a>
			</div>
